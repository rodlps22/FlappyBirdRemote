...
function ExpressTrain(dir, locs) {
    ...
    _.each(_.where(locations, {autoinject: true}), function (location) {
        var recurse = ("undefined" === typeof location.recurse || true === location.recurse) ? Infinity : location.recurse;
        traverseAndRegister(path.resolve(dir, location.path), tree, location.aggregateOn, recurse);
    });
